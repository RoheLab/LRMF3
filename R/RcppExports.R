...
colSums_svd_like_impl_cpp <- function(U, d, V) {
    .Call('_LRMF3_colSums_svd_like_impl_cpp', PACKAGE = 'LRMF3', U, d, V)
}
...
masked_approximation_impl <- function(U, V, row, col) {
    .Call('_LRMF3_masked_approximation_impl', PACKAGE = 'LRMF3', U, V, row, col)
}

rowSums_svd_like_impl_cpp <- function(U, d, V) {
    .Call('_LRMF3_rowSums_svd_like_impl_cpp', PACKAGE = 'LRMF3', U, d, V)
}
