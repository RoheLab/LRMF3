...
colSums_svd_like_impl <- function(U, d, V, num_threads) {
    .Call(`_LRMF3_colSums_svd_like_impl`, U, d, V, num_threads)
}
...
masked_approximation_impl <- function(U, V, row, col) {
    .Call(`_LRMF3_masked_approximation_impl`, U, V, row, col)
}

rowSums_svd_like_impl <- function(U, d, V, num_threads) {
    .Call(`_LRMF3_rowSums_svd_like_impl`, U, d, V, num_threads)
}
